...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \bowling_ball[0,0]__14\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \bowling_ball[0,17]\ : STD_LOGIC_VECTOR ( 2 to 2 );
  signal \bowling_ball[0,19]\ : STD_LOGIC_VECTOR ( 2 to 2 );
  ...
  signal pixel_y_reg : STD_LOGIC_VECTOR ( 8 downto 4 );
  signal \pixel_y_reg__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \NLW_fb_pixel2_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_5\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_10\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_15\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \pixel_y[1]_i_1\ : label is "soft_lutpair16";
...
\fb_addr_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => pixel_y_reg(6 downto 4),
      DI(0) => \pixel_y_reg__0\(3),
...
\fb_addr_reg[17]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => pixel_y_reg(4),
      DI(2 downto 0) => \pixel_y_reg__0\(3 downto 1),
...
fb_pixel2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => pixel_y_reg(5),
      DI(1) => fb_pixel2_carry_i_2_n_0,
      DI(0) => fb_pixel2_carry_i_3_n_0,
      O(3 downto 0) => NLW_fb_pixel2_carry_O_UNCONNECTED(3 downto 0),
      S(3) => fb_pixel2_carry_i_4_n_0,
      S(2) => fb_pixel2_carry_i_5_n_0,
      S(1) => fb_pixel2_carry_i_6_n_0,
      S(0) => fb_pixel2_carry_i_7_n_0
    );
\fb_pixel2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => fb_pixel2_carry_n_0,
      CO(3 downto 1) => \NLW_fb_pixel2_carry__0_CO_UNCONNECTED\(3 downto 1),
...
fb_pixel2_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
fb_pixel2_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
fb_pixel2_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
fb_pixel2_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
fb_pixel2_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel2_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel3_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => pixel_y_reg(8),
      S(2) => fb_pixel3_carry_i_5_n_0,
      S(1) => fb_pixel3_carry_i_6_n_0,
      S(0) => fb_pixel3_carry_i_7_n_0
    );
fb_pixel3_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel3_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel3_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel3_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
fb_pixel3_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
fb_pixel3_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
fb_pixel3_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\fb_pixel[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\fb_pixel[2]_i_20\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
