...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \color_cycle_clock[3]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \color_cycle_clock[8]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \curr_state[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \curr_state[1]_i_1\ : label is "soft_lutpair5";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \curr_state_reg[0]\ : label is "wait_rst:10,wait_after_pix:11,pix_out:01,";
  attribute FSM_ENCODED_STATES of \curr_state_reg[1]\ : label is "wait_rst:10,wait_after_pix:11,pix_out:01,";
  attribute SOFT_HLUTNM of \pixel[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pixel[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pixel[2]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pixel[2]_i_4\ : label is "soft_lutpair3";
begin
...
\curr_state[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
