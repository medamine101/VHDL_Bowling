...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[3]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_6\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_pixel[1]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_18\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_19\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_20\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_26\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_27\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_28\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_29\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_33\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_36\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_5\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \pixel[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \pixel[1]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \pixel_x[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pixel_x[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pixel_x[4]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \pixel_x[4]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \pixel_y[3]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pixel_y[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pixel_y[6]_i_2\ : label is "soft_lutpair17";
...
\fb_pixel[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\fb_pixel[0]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
...
\fb_pixel[2]_i_28\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
...
\fb_pixel[2]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
