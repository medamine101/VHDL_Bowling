...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  signal C : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  signal \fb_pixel_reg[0]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \color_cycle_clock[1]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \color_cycle_clock[6]_i_3\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_10\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_11\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_5\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_9\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[1]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_14\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_16\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_17\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_18\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_26\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_27\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_28\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_29\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_30\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_32\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_4\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \pixel_x[3]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pixel_x[4]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \pixel_x[4]_i_3\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \pixel_y[3]_i_2\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \pixel_y[7]_i_2\ : label is "soft_lutpair7";
begin
...
\fb_pixel[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
\fb_pixel[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF2"
    )
        port map (
...
\fb_pixel[2]_i_18\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\fb_pixel_reg[0]_i_3\: unisim.vcomponents.MUXF7
     port map (
...
\pixel_x[4]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
