...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \bowling_ball[0,0]__15\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \bowling_ball[0,1]/i_\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[3]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_14\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_19\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \pixel[2]_i_3\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \pixel_y[6]_i_2\ : label is "soft_lutpair15";
...
\bowling_ball[0,1]/i_\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01FF8000"
    )
        port map (
...
\fb_pixel[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      ...
      O => \bowling_ball[0,0]__15\(0)
    );
\fb_pixel[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00B0000000000070"
    )
        port map (
      I0 => \pixel_y_reg__0\(0),
...
\fb_pixel[2]_i_16\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
...
\fb_pixel[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \fb_pixel4_inferred__0/i__carry__2_n_0\,
