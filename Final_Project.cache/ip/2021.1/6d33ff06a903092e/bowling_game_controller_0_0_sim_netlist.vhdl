...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \color_cycle_clock[10]_i_3_n_0\ : STD_LOGIC;
  signal color_cycle_clock_reg : STD_LOGIC_VECTOR ( 10 downto 0 );
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \color_cycle_clock[8]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \color_cycle_clock[9]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pixel[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pixel[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \pixel[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \pixel[2]_i_3\ : label is "soft_lutpair5";
...
\FSM_sequential_curr_state[0]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\color_cycle_clock[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\color_cycle_clock[10]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\color_cycle_clock[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\color_cycle_clock[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
...
\color_cycle_clock[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
\color_cycle_clock_reg[10]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\color_cycle_clock_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pixel[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
