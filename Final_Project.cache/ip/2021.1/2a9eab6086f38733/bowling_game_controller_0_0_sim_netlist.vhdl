...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[1]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \fb_addr[17]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \pixel[2]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \pixel_y[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pixel_y[8]_i_1\ : label is "soft_lutpair0";
...
\color_cycle_clock[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\color_cycle_clock[6]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
