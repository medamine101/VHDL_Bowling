...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal fb_pixel15_out : STD_LOGIC;
  signal \fb_pixel1__25\ : STD_LOGIC;
  signal fb_pixel2 : STD_LOGIC;
  signal fb_pixel23_in : STD_LOGIC;
  ...
  signal fb_pixel32_in : STD_LOGIC;
  ...
  signal \pin_bowling[0,0]__19\ : STD_LOGIC_VECTOR ( 2 to 2 );
  ...
  signal pixel_y_reg : STD_LOGIC_VECTOR ( 8 downto 5 );
  signal \pixel_y_reg__0\ : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_10\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_11\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_18\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \bowling_ball_location_x[0]_i_19\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \bowling_ball_location_y[31]_i_11\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \bowling_ball_location_y[31]_i_12\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bowling_ball_location_y[31]_i_14\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \bowling_ball_location_y[31]_i_9\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \color_cycle_clock[1]_i_1\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \fb_pixel[0]_i_7\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \fb_pixel[1]_i_6\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_15\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_17\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_18\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_19\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_21\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_23\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_32\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_34\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \pixel_y[1]_i_1\ : label is "soft_lutpair19";
...
\fb_addr_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => pixel_y_reg(6 downto 5),
      DI(1 downto 0) => \pixel_y_reg__0\(4 downto 3),
...
\fb_addr_reg[17]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \pixel_y_reg__0\(4 downto 1),
...
\fb_pixel[2]_i_31\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\fb_pixel[2]_i_34\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\fb_pixel[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\fb_pixel_reg[2]_i_12\: unisim.vcomponents.MUXF7
     port map (
      ...
      O => \pin_bowling[0,0]__19\(2),
      S => \fb_pixel[1]_i_4_n_0\
    );
