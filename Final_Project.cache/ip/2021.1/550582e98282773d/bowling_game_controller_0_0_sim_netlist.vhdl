...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  attribute SOFT_HLUTNM of \fb_addr[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \fb_addr[10]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fb_addr[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fb_addr[12]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \fb_addr[13]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \fb_addr[14]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \fb_addr[15]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \fb_addr[16]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \fb_addr[17]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \fb_addr[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \fb_addr[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \fb_addr[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \fb_addr[4]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_addr[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \fb_addr[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_addr[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \fb_addr[8]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \fb_addr[9]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \pixel[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pixel[1]_i_1\ : label is "soft_lutpair1";
...
\pixel[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F708"
    )
        port map (
...
\pixel[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DFFF2000"
    )
        port map (
...
\pixel[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
