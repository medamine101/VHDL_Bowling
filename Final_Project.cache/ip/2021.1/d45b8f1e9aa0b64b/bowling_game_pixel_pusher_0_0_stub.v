...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, en, vs, pixel, hcount, vcount, vid, R, B, G, addr, 
  write_frame, blank_time)
/* synthesis syn_black_box black_box_pad_pin="clk,en,vs,pixel[2:0],hcount[9:0],vcount[9:0],vid,R[4:0],B[4:0],G[5:0],addr[17:0],write_frame,blank_time" */;
  input clk;
  input en;
  input vs;
  input [2:0]pixel;
