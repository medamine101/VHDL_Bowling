...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \in\ : STD_LOGIC_VECTOR ( 30 to 30 );
...
\bowling_ball_location_x[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => joystick_x(1),
      I3 => joystick_x(2),
      I4 => \bowling_ball_location_x[0]_i_8_n_0\,
...
\bowling_ball_location_x[0]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\bowling_ball_location_x[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\bowling_ball_location_x[0]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
        ...
        port map (
      I0 => right_in,
      I1 => \bowling_ball_location_x[0]_i_8_n_0\,
      I2 => joystick_x(2),
      I3 => joystick_x(1),
      I4 => joystick_x(4),
      I5 => joystick_x(3),
...
\bowling_ball_location_x_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \bowling_ball_location_x[0]_i_4_n_0\,
      S(2) => \bowling_ball_location_x[0]_i_5_n_0\,
      S(1) => \bowling_ball_location_x[0]_i_6_n_0\,
      S(0) => \bowling_ball_location_x[0]_i_7_n_0\
    );
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller
     port map (
      ...
      fb_pixel(2 downto 0) => fb_pixel(2 downto 0),
      game_clk => game_clk,
      joystick_x(7 downto 0) => joystick_x(7 downto 0),
      left_in => left_in,
      right_in => right_in,
      up_in => up_in
    );
