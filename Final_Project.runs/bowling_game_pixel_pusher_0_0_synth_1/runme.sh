...
HD_PWD='/home/user/Downloads/Final_Project/Final_Project.runs/bowling_game_pixel_pusher_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bowling_game_pixel_pusher_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bowling_game_pixel_pusher_0_0.tcl
