...
HD_PWD='C:/Users/moham/Documents/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bowling_game_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bowling_game_wrapper.tcl
