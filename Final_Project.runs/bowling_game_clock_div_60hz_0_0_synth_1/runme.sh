...
HD_PWD='/home/user/Documents/VHDL_Bowling/Final_Project.runs/bowling_game_clock_div_60hz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bowling_game_clock_div_60hz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bowling_game_clock_div_60hz_0_0.tcl
