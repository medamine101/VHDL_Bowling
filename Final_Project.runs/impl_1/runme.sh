...
HD_PWD='C:/Users/moham/Documents/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bowling_game_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bowling_game_wrapper.tcl -notrace
