...
architecture STRUCTURE of bowling_game_controller_0_0_controller is
  ...
  signal \pin_bowling[0,0]__19\ : STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_20\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_21\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_26\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_33\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \fb_pixel[2]_i_35\ : label is "soft_lutpair7";
...
\fb_pixel[2]_i_17\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
